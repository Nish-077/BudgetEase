   ...
   @PostMapping("/create-normal-transaction")
    ...
    public ResponseEntity<?> addTransactionToBudget(@Valid @RequestBody Transaction request, @PathVariable String budgetId){
        ...
        if (request.getBudgetId() == null) {
            request.setBudgetId(new ArrayList<>());
        }

       request.getBudgetId().add(budgetId);

       Transaction transaction = transactionService.addTransactionToBudget(request,budgetId);
    ...
    public ResponseEntity<?> addTransactionToGoal(@Valid @RequestBody Transaction request, @PathVariable String goalId){
        if (request.getGoalId() == null) {
            request.setGoalId(new ArrayList<>());
        }

        request.getGoalId().add(goalId);

       Transaction transaction = transactionService.addTransactionToGoal(request, goalId);
    ...
    @GetMapping("/getTransactionsByBudgetId/{budgetId}")
    public ResponseEntity<?> getTransactionsByBudgetId(@PathVariable String budgetId){
